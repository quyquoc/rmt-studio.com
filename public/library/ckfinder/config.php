...
function CheckAuthentication()
{
	...
	if(isset($_SESSION['ckfinder']['IsAuthorized'])){
		$permissions =	$_SESSION['ckfinder']['IsAuthorized'];
	} 
...
$config['AccessControl'] = isset($_SESSION['ckfinder']['AccessControl'])?$_SESSION['ckfinder']['AccessControl']:"";
/*
